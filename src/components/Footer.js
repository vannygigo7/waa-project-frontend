            ...
            <footer className="row py-5 mt-5 border-top">
                <div className="col">
                    <a href="/" className="d-flex justify-content-center mb-3 link-dark text-decoration-none">
                        <img className="navbar-brand" src={logoIcon} style={{ width: "50px", height: "50px" }} />
                    </a>
                    <p className="text-muted text-center">&copy; 2023</p>
                </div>

                <div className="col">
                    <ul className="nav justify-content-center pb-3 mt-2">
