...
export default function LandingPage() {
    ...
    return (
        <div>
                    ...
                    <div className="col des-text">
                        <div>
                            <div>
                                ...
                                <p className="mt-3">AuctionSnap is an easy-to-use, cost-efficient nonprofit auction tool
                                    with mobile bidding. Whether you are holding an in-person, online, or hybrid
                                    auction, AuctionSnap will streamline the process.</p>
                                <Link to={`/login`}>
                    ...
                    <div className="col">
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Seamlessly manage all auction items, details, and descriptions
                                    in one place—from start to finish.</p>
                            </div>
                        </div>
                    </div>
                    <div className="col">
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Make bidding easier, more accessible, and exciting, and see
                                    more action on your auctions.</p>
                            </div>
                        </div>
                    </div>
                    <div className="col">
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Empower guests to bid and checkout remotely or in-person
                                    directly from desktop and mobile.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <p className="text-center">Effortlessly manage every part of your nonprofit <br/> auctions, from listing
                items to checking out bidders.</p>
                    ...
                    <div className="col">
                        <div className="card m-auto border-white" style={{width: "25rem"}}>
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Organize items by type, tag, and starting bids for a seamless
                                    auction setup.</p>
                            </div>
                        </div>
                    </div>
                    <div className="col">
                        <div className="card m-auto border-white" style={{width: "25rem"}}>
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Encourage healthy competition and maximize bids with automated
                                    bidding functionality.</p>
                            </div>
                        </div>
                    </div>
                    <div className="col">
                        <div className="card m-auto border-white" style={{width: "25rem"}}>
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Engage participants and increase anticipation with live,
                                    dynamic bidding from their devices.</p>
                            </div>
                        </div>
                    </div>
                    <div className="col">
                        <div className="card m-auto border-white" style={{width: "25rem"}}>
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Expedite post-event checkouts with our secure and convenient
                                    mobile checkout process.</p>
                            </div>
                        </div>
                    </div>
                </div>
